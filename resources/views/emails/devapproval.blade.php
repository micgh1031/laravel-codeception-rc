        ...
        <tbody><tr>
          <td style="padding: 0;vertical-align: top">
            <table style="border-collapse: collapse;border-spacing: 0;width: 602px">
              <tbody><tr>
                <td class="title" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: left;color: #999;font-family: Georgia,serif">Your Profile has been featured on Laranaija</td>
...
<h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 18px;font-family: sans-serif;line-height: 42px">Hello,</h1><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">I wanted to drop you a note to let you know your profile has now been approved and featured publicly on Laranaija. Here’s a link, check out your profile here:&nbsp;<a style="text-decoration: underline;transition: all .2s;color: #41637e" href="http://unicodelabs.createsend1.com/t/i-l-jlihlhk-l-r/" target="_blank">http://laranaija.com/developers</a></p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px"><em>Laranaija.com is a hub for Developers in Nigeria that manipulate and craft web applications using the Wonderful Laravel Framework. It
              ...
              <tbody><tr>
                <td class="social-link" style="padding: 0;vertical-align: top">
                  <table style="border-collapse: collapse;border-spacing: 0">
                    <tbody><tr>
                      <td style="padding: 0;vertical-align: top">
                        <a style="text-decoration: none;transition: all .2s;color: #999;letter-spacing: 0.05em;font-family: Georgia,serif" href="https://www.facebook.com/otemuyiwa.prosper" rel="cs_facebox" cs_likeurl="/t/i-fb-jlihlhk-l-t/?act=like" target="_blank">
